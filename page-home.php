...
<div id="banner" class="container-fluid" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url(<?php echo $bannerurl['sizes']['banner'];?>); background-position: center; background-size: cover; ">
